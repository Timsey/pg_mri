...
--batch_size 2 --accelerations 32 --acquisition_steps 28 --sample-rate 0.2 \
--center-volume False --wandb True --project mrimpro_brain --partition test --model_type oracle