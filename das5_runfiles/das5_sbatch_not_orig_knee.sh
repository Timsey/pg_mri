...
--dataset fastmri --data-path /var/scratch/tbbakker/data/fastMRI/singlecoil/ --exp-dir /var/scratch/tbbakker/mrimpro/non_orig_knee_results/ --resolution 128 \
...
--project mrimpo_knee_nonorig --original_setting False --low_res False
...
--wandb True --do-train-ssim True --project mrimpo_knee_nonorig --original_setting False --low_res False --gamma 1.0
