...
--estimator full_step --num-trajectories 16 --num-dev-trajectories 8 --greedy False --data-range volume --baseline-type selfstep \
--scheduler-type multistep --lr-multi-step-size 10 20 30 40 --lr-gamma .5 --acquisition None --center-volume True --batches-step 2 \
--wandb True --do-train-ssim True --project mrimpro_gamma --original_setting True --low_res False --gamma 0.1
...
--estimator full_step --num-trajectories 16 --num-dev-trajectories 8 --greedy False --data-range volume --baseline-type selfstep \
--scheduler-type multistep --lr-multi-step-size 10 20 30 40 --lr-gamma .5 --acquisition None --center-volume True --batches-step 2 \
--wandb True --do-train-ssim True --project mrimpro_gamma --original_setting True --low_res False --gamma 0.9
...
--estimator full_step --num-trajectories 16 --num-dev-trajectories 8 --greedy False --data-range volume --baseline-type selfstep \
--scheduler-type multistep --lr-multi-step-size 10 20 30 40 --lr-gamma .5 --acquisition None --center-volume True --batches-step 2 \
--wandb True --do-train-ssim True --project mrimpro_gamma --original_setting True --low_res False --gamma 1.0