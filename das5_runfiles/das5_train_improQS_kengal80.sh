...
--fc-size 256 --out-chans 64 --accelerations 8 --acquisition-steps 10 --report-interval 10 --num-target-rows 80 --lr 1e-3 --sample-rate 0.04 \
--seed 42 --num-workers 8 --in-chans 1 --lr-gamma 0.1 --center-volume --start-eps 0.0 --tau 0.1 \
--wandb --scheduler-type step --lr-step-size 40 --acquisition CORPD_FBK