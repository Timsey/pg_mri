...
#SBATCH -C GTX1080Ti  # Welke gpus heb je nodig?
...
--of-which-four-pools 0 --num-chans 8 --batch-size 8 --impro-model-name convpool --fc-size 256 --accelerations 8 --acquisition-steps 16 --report-interval 1000 \
