...
--of-which-four-pools 0 --num-chans 20 --batch-size 16 --impro-model-name convpool --fc-size 512 --accelerations 8 --acquisition-steps 16 --report-interval 100 \
...
--estimator full_step --num-trajectories 2 --num-dev-trajectories 2 --greedy False
