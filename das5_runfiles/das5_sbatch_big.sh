...
--estimator wr --acq_strat max --acquisition None --use-data-state True --center-volume True
...
--estimator wr --acq_strat max --acquisition None --center-volume True --use-data-state True
...
--of-which-four-pools 0 --num-chans 16 --batch-size 16 --impro-model-name convpool --fc-size 256 --accelerations 8 --acquisition-steps 16 --report-interval 100 \
--num-target-rows 20 --lr 1e-4 --sample-rate .2 --seed 0 --num-workers 0 --in-chans 1 --lr-gamma 0.1 --num-epochs 50 --lr-step-size 40 --num-pools 4 --pool-stride 1 \
--estimator wr --acq_strat max --acquisition CORPD_FBK --center-volume True --use-data-state True
...
#--scheduler-type multistep --lr-multi-step-size 10 20 --lr-gamma .2 --acquisition None --center-volume --batches-step 4
#        # Average oracle
...
#--estimator wr --acq_strat max --acquisition CORPD_FS --center-volume
#            # Nongreedy with self baseline (schedule)
#CUDA_VISIBLE_DEVICES=0,1,2,3 PYTHONPATH=/var/scratch/tbbakker/anaconda3/envs/fastmri/lib/python3.7/site-packages python -m src.train_RL_model_sweep \
#--dataset fastmri --data-path /var/scratch/tbbakker/data/fastMRI/singlecoil/ --exp-dir /var/scratch/tbbakker/mrimpro/results/ --resolution 128 \
#--recon-model-checkpoint /var/scratch/tbbakker/fastMRI-shi/models/unet/al_nounc_res128_8to4in2_PD_cvol_symk/model.pt --recon-model-name nounc \
...
#--scheduler-type multistep --lr-multi-step-size 10 20 30 40 --lr-gamma .5 --acquisition CORPD_FS --center-volume