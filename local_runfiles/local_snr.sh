...
--original_setting True --low_res False --style stoch --data_runs 3 --force_computation False --epochs 0 9 19 29 39 49 --base_impro_model_dir /home/timsey/Projects/mrimpro/gamma_results_fix/ \
